...
/usr/sbin/nginx
# start fastcgi
/usr/bin/spawn-fcgi -s /var/run/munin/fastcgi-munin-graph.sock -U www-data -u munin -g www-data -P /var/run/munin/fastcgi-munin-graph.pid /usr/lib/munin/cgi/munin-cgi-graph
/usr/bin/spawn-fcgi -s /var/run/munin/fastcgi-munin-html.sock -U www-data -u munin -g www-data -P /var/run/munin/fastcgi-munin-html.pid /usr/lib/munin/cgi/munin-cgi-html
# show logs
